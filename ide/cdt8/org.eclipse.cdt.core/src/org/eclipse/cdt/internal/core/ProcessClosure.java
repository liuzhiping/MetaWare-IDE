...
public class ProcessClosure {
	...
	public void terminate() {
		...
		//CUSTOMIZATION
		//CR:9000667947 
		//We don't need to wait for Reader to finish
		//as we want to terminate the build
		//the below could cause to wait very long if the task is long
		/*if (!fOutputReader.finished()) {
			fOutputReader.waitFor();
		...
		//CUSTOMIZATION
		//CR:9000616547
		//Process should be destroy after Reader is done
		if (fProcess != null) {
			fProcess.destroy();
			fProcess = null;
		}

...
public abstract class GNUScannerExtensionConfiguration extends AbstractScannerExtensionConfiguration {
	...
	public GNUScannerExtensionConfiguration() {
		...
		addMacro("_Stdcall",""); // CUSTOMIZATION
		addMacro("__restrict",""); // CUSTOMIZATION
		addMacro("__restrict__",""); // CUSTOMIZATION
		addMacro("_Far",""); // CUSTOMIZATION
		addMacro("_Near",""); // CUSTOMIZATION
		addMacro("_Huge",""); // CUSTOMIZATION
		addMacro("_Dstdcall",""); //CUSTOMIZATION
		addMacro("_DPascal",""); // CUSTOMIZATION
		addMacro("_Uncached",""); // CUSTOMIZATION
		addMacro("_Never_returns",""); // CUSTOMIZATION
    	...
    	addPreprocessorKeyword("c_include".toCharArray(), IPreprocessorDirective.ppInclude);  //CUSTOMIZATION
		...
		addKeyword("_Asm".toCharArray(), IToken.t_asm); // CUSTOMIZATION High C qualifier
		...
		addKeyword("_CC".toCharArray(), IGCCToken.t__declspec ); // CUSTOMIZATION
		addKeyword("_Overlay".toCharArray(), IGCCToken.t__declspec ); // CUSTOMIZATION
		//CR:9000598504
		addKeyword("_Inline".toCharArray(), IGCCToken.t_inline ); // CUSTOMIZATION
		//CR:9000617705
		addKeyword("_Unaligned".toCharArray(), IGCCToken.t__declspec ); // CUSTOMIZATION
		...
		addKeyword("_Typeof".toCharArray(), IGCCToken.t_mw_typeof); //CUSTOMIZATION
		addKeyword("_Pragma".toCharArray(), IGCCToken.t_PRAGMA); // CUSTOMIZATION
		addKeyword("_wchar_t".toCharArray(), IToken.t_char); // CUSTOMIZATION

...
public interface IGCCToken extends IToken {
	...
	//CUSTOMIZATION
	 public static final int t_mw_typeof = FIRST_RESERVED_IGCCToken + 27; // _Typeof<id> from MetaWare C 
	 public static final int t_PRAGMA = FIRST_RESERVED_IGCCToken + 28; // _Pragma from MetaWare 
}

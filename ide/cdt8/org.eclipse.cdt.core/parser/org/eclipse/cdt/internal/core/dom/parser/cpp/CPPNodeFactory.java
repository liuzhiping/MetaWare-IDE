...
import org.eclipse.cdt.core.dom.ast.IASTFunctionStyleAsmDeclaration;	//CUSTOMIZATION
...
public class CPPNodeFactory extends NodeFactory implements ICPPNodeFactory {
	...
	//<CUSTOMIZATION>
	@Override
	public IASTRegisterInitializer newRegisterInitializer(IASTInitializerClause initClause) {
		return new CPPASTRegisterInitializer(initClause);
	}
	//</CUSTOMIZATION>
	...
	//<CUSTOMIZATION>
	@Override
	public IASTFunctionStyleAsmDeclaration newFunctionStyleAsmDeclaration(IASTDeclSpecifier declSpecifier, IASTFunctionDeclarator declarator,
			IASTStatement bodyStatement) {
		return new CPPASTFunctionStyleAsmDeclaration(declSpecifier, declarator, bodyStatement);
	}
	//</CUSTOMIZATION>
	...
	//CUSTOMIZATION
	public IASTForLoopStatement newForLoopStatement(List<IASTSimpleDeclaration> controlVars,
			IASTExpression call, IASTStatement body) {
		CPPASTForLoopStatement s = new CPPASTForLoopStatement();
		for (IASTSimpleDeclaration v: controlVars){
			s.addControlVariable(v);
		}
		s.setIteratorExpression(call);
		s.setBody(body);
		return s;
	}
}

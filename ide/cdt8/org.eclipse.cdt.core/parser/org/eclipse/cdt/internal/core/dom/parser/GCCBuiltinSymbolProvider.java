...
public class GCCBuiltinSymbolProvider implements IBuiltinBindingsProvider {
	...
	private void initialize() {
		...
		addMetawareIntrinsics(); // CUSTOMIZATION
	...
	//CUSTOMIZATION START
	//DesignWare C/C++ Programmer's Guide for the MetaWare Compiler for ARC
	//Appendix B Intrinsic Functions
	//STAR 9000645254
	//_abs, _min, and _max are added into the method void metaware().
	private void addMetawareIntrinsics() {
//		String[] types= {"int", "long", "long long", "unsigned int", "unsigned long", "unsigned long long", "float", "double"};
//		for (String type : types) {
//			function(type, 				"_abs", type);
//			function(type, 				"_min", type);
//			function(type, 				"_max", type);
//		}
		
		function("void*", 				"_Alloca", "size_t");
		function("void", 				"_ASM", "");
		function("unsigned int",		"_bmsk", "unsigned int", "unsigned int");
		function("void",				"_brk", "void");
		
		//on the manual, the prototype is "int __builtin_constant_p(value)"
		//it's similar with the "type __builtin_choose_expr(const_expr, expr1, expr2)"
		function("int",					"__builtin_constant_p", "");
		
		function("unsigned int", 		"_clri", "void");
		function("unsigned int",		"_condition", "unsigned int");
		function("unsigned int",		"_core_read", "unsigned int");
		function("void",				"_core_write", "unsigned int", "unsigned int");
		function("void",				"_disable", "void");
		function("void", 				"_disable1", "void");
		function("void", 				"_disable2", "void");
		function("unsigned long", 		"_dmach", "unsigned long", "unsigned long");
		function("unsigned long", 		"_dmachu", "unsigned long", "unsigned long");
		function("long long", 			"_dmacwh", "long long", "long");
		function("long long", 			"_dmacwhu", "long long", "long");
		function("long", 				"_dmpyh", "long", "long");
		function("unsigned long", 		"_dmpyhu", "unsigned long", "unsigned long");
		function("long long", 			"_dmpywh", "long long", "long");
		function("long long", 			"_dmpywhu", "long long", "long");
		function("int", 				"_mac", "int", "int");
		function("long long", 			"_macd", "int", "int");
		function("unsigned long long", 	"_macdu", "int", "int");
		function("unsigned int", 		"_macu", "unsigned int", "unsigned int");
		function("unsigned long long", 	"_mpyd", "int", "int");
		function("unsigned long long", 	"_mpydu", "unsigned int", "unsigned int");
		function("long long", 			"_qmach", "long long", "long long");
		function("long long", 			"_qmachu", "long long", "long long");
		function("long long", 			"_qmpyh", "long long", "long long");
		function("long long", 			"_qmpyhu", "long long", "long long");
		function("long", 				"_vadd2h", "long", "long");
		function("long long", 			"_vadd2", "long long", "long long");
		function("long long", 			"_vadd4h", "long long", "long long");
		function("long long", 			"_vaddsub", "long long", "long long");
		function("long long", 			"_vaddsub4h", "long long", "long long");
		function("long", 				"_vaddsub2h", "long", "long");
		function("long", 				"_vsub2h", "long", "long");
		function("long", 				"_vsubadd2h", "long", "long");
		function("long", 				"_vmpy2h", "long", "long");
		function("unsigned long long", 	"_vmpy2hu", "long", "long");
		function("long long", 			"_vsub2", "long long", "long long");
		function("long long", 			"_vsub4h", "long long", "long long");
		function("long long", 			"_vsubadd", "long long", "long long");
		function("long long", 			"_vsubadd4h", "long long", "long long");
		function("void", 				"_enable", "void");
		function("void", 				"_enable1", "void");
		function("void", 				"_enable2", "void");
		function("void", 				"_flag", "unsigned int");
		function("long*", 				"_interrupt_ext_addr", "void");
		function("unsigned int", 		"_lr", "unsigned int");
		
		function("void", 				"_nop", "void");
		function("void", 				"_prefetch", "void*");
		function("unsigned int", 		"_seti", "unsigned int");
		function("void", 				"_sleep", "void");
		function("void", 				"_sleep", "int");
		function("void", 				"_sr", "unsigned int", "unsigned int");
		function("void", 				"_sync", "void");
		
		//CDT doesn't support type short, on the manual, the prototype is "short _swap16(short)"
		//but use type int instead of short will have no ill effect.
		function("int", 				"_swap16", "int");
		
		function("int", 				"_swap32", "int");
		function("void", 				"_swi", "void");
	}
    ...
    private void metaware(){	 
	     IType[] parms = new IType[1];
	     parms[0] = c_int; 
	     IBinding abs;
	     if (lang == ParserLanguage.C) {
	    	 IFunctionType functionType = new CFunctionType(c_int, parms);
	         IParameter[] theParms = new IParameter[1];
	         theParms[0] = new CBuiltinParameter(parms[0]);
	         abs = new CImplicitFunction("_abs".toCharArray(), fScope, functionType, theParms, false); //$NON-NLS-1$
	     }
	     else {
	    	 ICPPFunctionType functionType = new CPPFunctionType(c_int, parms);
	         ICPPParameter[] theParms = new ICPPParameter[1];
	         theParms[0] = new CPPBuiltinParameter(parms[0]);
	         abs = new CPPImplicitFunction("_abs".toCharArray(), fScope, functionType, theParms, false); //$NON-NLS-1$
	     }
	     
	     IBinding min = doMinMax("_min"); //$NON-NLS-1$
	     IBinding max = doMinMax("_max"); //$NON-NLS-1$
	     /*fBindings = (IBinding[]) ArrayUtil.append(IBinding.class, fBindings, abs);
	     fBindings = (IBinding[]) ArrayUtil.append(IBinding.class, fBindings, min);
	     fBindings = (IBinding[]) ArrayUtil.append(IBinding.class, fBindings, max);*/
	     
	     fBindingList.add(abs);
	     fBindingList.add(min);
	     fBindingList.add(max);
	     
    }

	// CUSTOMIZATION
	private IBinding doMinMax(String name) {
		if (lang == ParserLanguage.C) {
			...
			return new CImplicitFunction(name.toCharArray(), fScope, functionType, theParms, true);
		} else {
			IType[] parms = new IType[2];
			parms[0] = c_int;
			parms[1] = c_int;
			...
			return new CPPImplicitFunction(name.toCharArray(), fScope, functionType, theParms, true);
		}
	}

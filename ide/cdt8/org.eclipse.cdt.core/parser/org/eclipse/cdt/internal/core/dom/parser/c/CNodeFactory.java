...
public class CNodeFactory extends NodeFactory implements ICNodeFactory {
	...
	public IASTRegisterInitializer newRegisterInitializer(IASTInitializerClause initClause) {
		return new CASTRegisterInitializer(initClause);
	}
	//</CUSTOMIZATION>
	...
	//<CUSTOMIZATION>
	@Override
	public IASTFunctionStyleAsmDeclaration newFunctionStyleAsmDeclaration(IASTDeclSpecifier declSpecifier,
			IASTFunctionDeclarator declarator, IASTStatement bodyStatement) {
		return new CASTFunctionStyleAsmDeclaration(declSpecifier, declarator, bodyStatement);
	}
	//</CUSTOMIZATION>

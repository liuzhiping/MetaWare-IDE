...
public class InitializerWriter extends NodeWriter{
	...
	protected void writeInitializer(IASTInitializer initializer) {
		//<CUSTOMIZATION>
		if (initializer instanceof IASTRegisterInitializer) {
			writeRegisterInitializer((IASTRegisterInitializer) initializer);
...
//		if (initializer instanceof IASTEqualsInitializer) {
	...
	//<CUSTOMIZATION>
	private void writeRegisterInitializer(IASTRegisterInitializer initializer) {
		scribe.print(" == ");
		IASTInitializerClause init = initializer.getInitializerClause();
		if (init != null) {
			init.accept(visitor);

 ...
 *     Marc-Andre Laperle
 *     Synopsys
 *     DAVID_REVIEW: no getThisType for CUSTOMIZATION part
 *******************************************************************************/
...
//					oldBinding..
//				}
			return  scope.getBinding(alias.getTargetName(), false);
	...
	private static IScope getContainingScopeOrNull(IASTName name) {
		...
		try {
			...
			if (parent instanceof ICPPASTFieldReference) {
				...
				//DAVID_REVIEW as new code didnot checking if fieldReference not pointer dereference
				//<CUSTOMIZATION>

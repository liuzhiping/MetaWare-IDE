...
public class CPPASTFunctionDeclarator extends CPPASTDeclarator implements ICPPASTFunctionDeclarator,
    ...
    public void prependParameterDeclaration(IASTParameterDeclaration parameter){
    	if (parameter != null){
    		parameter.setParent(this);
    		parameter.setPropertyInParent(FUNCTION_PARAMETER);
    		//DAVID_REVIEW as IASTParameterDeclaration (parent class) now cast to  ICPPASTParameterDeclaration(child class)
    		parameters = (ICPPASTParameterDeclaration[]) ArrayUtil.prepend(ICPPASTParameterDeclaration.class, parameters, ((ICPPASTParameterDeclaration) parameter));
    	}
    }
}

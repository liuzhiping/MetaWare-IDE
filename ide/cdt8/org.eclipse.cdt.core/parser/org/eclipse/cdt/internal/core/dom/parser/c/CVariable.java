...
public class CVariable extends PlatformObject implements IInternalVariable, ICInternalBinding {
	...
	private IValue getInitialValue(IASTName name, int maxDepth) {
		...
		if (dtor != null) {
			...
			//<CUSTOMIZATION>
			//TODO: right now, just same as IASTEqualsInitializer, need read register's real value.
			if (init instanceof IASTRegisterInitializer) {
				final IASTInitializerClause initClause = ((IASTRegisterInitializer) init)
...
//			if (init instanceof IASTEqualsInitializer) {
	...
	void setType(IType type){ //CUSTOMIZATION
        this.type = type;
    }

...
public class CProjectDescriptionPreferences implements ICProjectDescriptionPreferences {
	...
	//CUSTOMIZATION: it is more intuitive that the active configuration be used to do indexing, etc.
	private static final int DEFAULT_RELATIONS = CONFIGS_LINK_SETTINGS_AND_ACTIVE; //CONFIGS_INDEPENDENT;

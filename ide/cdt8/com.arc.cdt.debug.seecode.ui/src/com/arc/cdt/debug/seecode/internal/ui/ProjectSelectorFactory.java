...
//                }
    ...
    private static ICProject chooseCProject(Shell shell, IProject defaultProject) {
        try {
            ...
            dialog.setTitle(Messages.getString("CMainTab.Project_Selection")); //$NON-NLS-1$
            dialog.setMessage(Messages.getString("CMainTab.Choose_project_to_constrain_search_for_program")); //$NON-NLS-1$

...
//    }
    ...
    protected IArgsFileLocator getArgsFileLocator() {
        return new IArgsFileLocator(){
            ...
            public File computePropertiesFile(String prefix) {
            	File d = mSession.getSessionDirectory();
    ...
    protected void showHelpForID(String id){
        ...
        if (context == null && id.indexOf('.') < 0){
        	// Add associated plugin if not found.
        	String tadID = PLUGIN_ID + '.' + id;
        	context = HelpSystem.getContext(tadID);
        }
        if (context == null){

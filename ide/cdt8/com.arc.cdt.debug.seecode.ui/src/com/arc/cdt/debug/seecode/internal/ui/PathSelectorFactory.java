...
class PathSelectorFactory {
    ...
    private static String searchProjectForFile (Shell shell, ISelectionContext context, String description) {
        ...
        dialog.setMessage(description/*Messages.getString("CMainTab.Choose_program_to_run")*/); 
        dialog.setTitle("File Selection"); //$NON-NLS-1$
        dialog.setUpperListLabel("Discovered file list"/*Messages.getString("Launch.common.BinariesColon*/); //$NON-NLS-1$
        dialog.setLowerListLabel(Messages.getString("Launch.common.QualifierColon")); //$NON-NLS-1$

...
public class ToolChainEditTab extends AbstractCBuildPropertyTab {
	...
	//private static final IToolChain[] r_tcs = ManagedBuildManager.getRealToolChains(); -- CUSTOMIZATION
	private static final IBuilder[]    r_bs = ManagedBuildManager.getRealBuilders();
	//CUSTOMIZATION: only supported tools
	//private static final ITool[]    r_tools = ManagedBuildManager.getRealTools();
	private static final ITool[]    r_tools   = ManagedBuildManager.getRealSupportedTools(); 
...
//			fim.getProjectToolModifications();
	...
	private void fillToolChainCombo() {
		...
		IToolChain[] tcs = ManagedBuildManager.getRealToolChainsForConfig(cfg != null?cfg.getName():null,
				cfg != null?cfg.getBuildArtefactType():null); //CUSTOMIZATION

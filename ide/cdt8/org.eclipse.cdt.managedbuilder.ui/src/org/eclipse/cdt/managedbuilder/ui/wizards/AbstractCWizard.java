...
public abstract class AbstractCWizard extends CNewWizard {
	 ...
	 * @param tc
	 * @return
	 *  CUSTOMIZATION: made public and static
	 */
	public static boolean isValid(IToolChain tc, boolean supportedOnly, IWizard w) {
	 ...
	 * CUSTOMIZATION: made public and static
	 */
	protected static boolean isLanguageCompatible(IToolChain tc, IWizard w) {
		if (w == null) 
			return true;

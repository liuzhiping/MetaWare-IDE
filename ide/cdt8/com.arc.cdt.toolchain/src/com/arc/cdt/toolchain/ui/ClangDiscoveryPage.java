/*******************************************************************************
 * Copyright (c) 2005-2013 Synopsys, Incorporated
 ...
 * @author davidp
 */
public class ClangDiscoveryPage extends AbstractDiscoveryPage {

    private static final String PROVIDER_ID = "HighCSpecsFile";

    private static final String DEFAULT_OPTS = "-v -E -dM";

    private static final String DEFAULT_ARGS = DEFAULT_OPTS + " ${plugin_state_location}/${specs_file}";

    private Text compileField;

    private Text argsField;

    public ClangDiscoveryPage() {
        super();
    }

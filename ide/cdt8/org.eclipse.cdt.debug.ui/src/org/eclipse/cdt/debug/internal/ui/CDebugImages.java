...
//	private static final String T_ETOOL = "etool16"; //$NON-NLS-1$
	...
	//CUSTOMIZATION
	public static final String IMG_OBJS_HARDWARE_BREAKPOINT_ENABLED = NAME_PREFIX + "hw_brkp_obj.gif";  //$NON-NLS-1
	public static final String IMG_OBJS_HARDWARE_BREAKPOINT_DISABLED = NAME_PREFIX + "brkpd_obj.gif";   //$NON-NLS-1
	public static final ImageDescriptor DESC_OBJS_HARDWARE_BREAKPOINT_ENABLED = createManaged( T_OBJ, IMG_OBJS_HARDWARE_BREAKPOINT_ENABLED );
	public static final ImageDescriptor DESC_OBJS_HARDWARE_BREAKPOINT_DISABLED = createManaged( T_OBJ, IMG_OBJS_HARDWARE_BREAKPOINT_DISABLED );	

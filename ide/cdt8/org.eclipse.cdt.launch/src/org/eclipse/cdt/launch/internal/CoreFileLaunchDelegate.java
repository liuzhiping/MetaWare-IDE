...
public class CoreFileLaunchDelegate extends AbstractCLaunchDelegate {
	...
	protected IPath promptForCoreFilePath(final IProject project, final ICDebugConfiguration debugConfig) throws CoreException {
		...
		//CUSTOMIZATION: changed 101 to 301; 101 is already used for missing working directory.
		// Must coincide with org.eclipse.debug.core.statusHandlers code as defined in plugin.xml.
		IStatus processPrompt = new Status(IStatus.INFO, "org.eclipse.cdt.launch", ICDTLaunchConfigurationConstants.ERR_NO_COREFILE, "", null); //$NON-NLS-1$//$NON-NLS-2$
		// consult a status handler

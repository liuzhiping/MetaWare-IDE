...
***
*** Comments:      
***   This file contains the function for destroying a semaphore quickly.
***                                                               
***
**************************************************************************
*END*********************************************************************/
...
/*FUNCTION*-------------------------------------------------------------------
* 
* Function Name    : _sem_destroy_fast
...
* Comments         :
*   Used to destroy an instance of a semaphore using an index.
* 
*END*----------------------------------------------------------------------*/

_mqx_uint _sem_destroy_fast
   (
      /* [IN] the index of the semaphore to destroy */
      _mqx_uint sem_index,

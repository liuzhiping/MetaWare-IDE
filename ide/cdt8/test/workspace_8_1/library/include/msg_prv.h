...
#define PROC_MASK                (0xffff)
#define PROC_SHIFT               (16)
#define QUEUE_MASK               (0xffff)
#define MAX_PROCESSORS           (0x10000)
#define MAX_QNUMBERS             (0x10000)
#else
#define PROC_MASK                (0xff)
#define PROC_SHIFT               (8)
#define QUEUE_MASK               (0xff)
#define MAX_PROCESSORS           (256)
#define MAX_QNUMBERS             (256)
#endif

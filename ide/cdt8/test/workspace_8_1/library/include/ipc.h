...
** Error messages
*/
#define IPC_ROUTE_EXISTS              (0xC001)

/*
** Define the stack size for the IPC
*/
#define IPC_DEFAULT_STACK_SIZE \
   ((256*sizeof(_mem_size))+PSP_STACK_KLOG_OVERHEAD)
...
extern IPC_PROTOCOL_INIT_STRUCT _ipc_init_table[];
extern IPC_ROUTING_STRUCT       _ipc_routing_table[];

...
/* Start CR 2396 */
#if MQX_USE_PMU
#define KLOG_PMU_FUNCTIONS            (uint_32)(0x00400000)
#endif
/* End CR 2396 */
...
#if MQX_USE_PMU
/* PMU functions */
#define KLOG_pmu_powerdown_start               (KLOG_PMU_FUNCTIONS+1)
#define KLOG_pmu_powerdown_end                 (KLOG_PMU_FUNCTIONS+2)
#define KLOG_ep_dvfs_adjust_time               (KLOG_PMU_FUNCTIONS+3)
#endif
/* End CR 2396 */

...
*** Comments: 
***                                   
***    This file contains the configuration definitions for configuring
*** the various optional features of MQX.
***    Individual config. defines can be overrridden by using the -D
*** option on the compiler command line. This elimates the need to manaully
*** modfiy this file.
***    Note that each PSP also has an assembler configuration file 
*** psp_cnfg.<comp> which provides configuration information for the PSP.  
*** This file can be found in each PSP source directory: 
***      \source\psp\<psp>\psp_cnfg.<comp>
***
*** MQX is delivered configured as follows:
***
***   MQX_CHECK_ERRORS                     1
...
/* Start CR 2396 */
/* 
** When MQX_USE_PMU is defined as 1,
** then mqx will support Power Management Unit
*/
#ifndef MQX_USE_PMU
#define MQX_USE_PMU 1
#endif
/* End CR 2396 */

#ifndef __acaa600_h__
#define __acaa600_h__ 1
/*HEADER******************************************************************
**************************************************************************
***
...
*/
#define BSP_ACAA600		    TRUE
#define BSP_CPU_TYPE PSP_CPU_TYPE_ARC_A600
...
#define BSP_PERIPHERAL_BASE         (0x00FC0000)
/* End CR 2397 */
...
/* register base for the uart */
/* Start CR 2397 */
#define BSP_VUART1_BASE                         (BSP_PERIPHERAL_BASE + 0x1000)
/* End CR 2397 */
...
/* Start CR 2397 */
#define BSP_VUART2_BASE                         0
/* #define BSP_VUART2_BASE                         (BSP_PERIPHERAL_BASE + 0x1100) */
/* End CR 2397 */
...
/* Start CR 2397 */
#define BSP_VMAC1_ENET_BASE                        (BSP_PERIPHERAL_BASE + 0x2000)
/* End CR 2397 */
...
*/
#define BSP_DCACHE_MODE   PSP_AUX_DC_CTRL_ENABLE_BYPASS
/* End Cr 2354 */

/* Set this define to 1 to enable and use the code ram */
#define BSP_USE_CODERAM       0
/*
...
#else
#define BSP_TIMER_INTERRUPT_VECTOR          PSP_EXCPT_7_VECTOR
#endif
#define BSP_TIMER_INTERRUPT_LEVEL           (1)

#define BSP_VUART1_INTERRUPT_VECTOR         PSP_EXCPT_8_VECTOR
#define BSP_VUART1_INTERRUPT_LEVEL          (1)
#define BSP_VUART2_INTERRUPT_VECTOR         PSP_EXCPT_9_VECTOR
#define BSP_VUART2_INTERRUPT_LEVEL          (1)
#define BSP_VUART3_INTERRUPT_VECTOR         PSP_EXCPT_10_VECTOR
#define BSP_VUART3_INTERRUPT_LEVEL          (1)
#define BSP_VUART4_INTERRUPT_VECTOR         PSP_EXCPT_11_VECTOR
#define BSP_VUART4_INTERRUPT_LEVEL          (1)
#define BSP_VUART5_INTERRUPT_VECTOR         PSP_EXCPT_12_VECTOR
#define BSP_VUART5_INTERRUPT_LEVEL          (1)
#define BSP_VUART6_INTERRUPT_VECTOR         PSP_EXCPT_13_VECTOR
#define BSP_VUART6_INTERRUPT_LEVEL          (1)
#define BSP_VUART7_INTERRUPT_VECTOR         PSP_EXCPT_14_VECTOR
#define BSP_VUART7_INTERRUPT_LEVEL          (1)
#define BSP_VUART8_INTERRUPT_VECTOR         PSP_EXCPT_15_VECTOR
#define BSP_VUART8_INTERRUPT_LEVEL          (1)

#define BSP_VMAC1_INTERRUPT_VECTOR          PSP_EXCPT_16_VECTOR
...
#define BSP_LAST_INTERRUPT_VECTOR_USED       PSP_EXCPT_31_VECTOR

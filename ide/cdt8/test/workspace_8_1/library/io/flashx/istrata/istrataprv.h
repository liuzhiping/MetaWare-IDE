...
extern boolean _intel_strata_check_timeout(MQX_TICK_STRUCT_PTR, _mqx_uint);
extern boolean _intel_strata_program_1byte(IO_FLASHX_STRUCT_PTR, uchar_ptr,
   uchar_ptr, _mem_size, _mqx_uint);
extern boolean _intel_strata_erase_1byte(IO_FLASHX_STRUCT_PTR, uchar_ptr,
   _mem_size, MQX_TICK_STRUCT_PTR);
extern boolean _intel_strata_program_2byte(IO_FLASHX_STRUCT_PTR, uint_16_ptr,
   uint_16_ptr, _mem_size, _mqx_uint);
extern boolean _intel_strata_erase_2byte(IO_FLASHX_STRUCT_PTR, uint_16_ptr,
   _mem_size, MQX_TICK_STRUCT_PTR);
extern boolean _intel_strata_program_4byte(IO_FLASHX_STRUCT_PTR, uint_32_ptr,
   uint_32_ptr, _mem_size, _mqx_uint);
extern boolean _intel_strata_erase_4byte(IO_FLASHX_STRUCT_PTR, uint_32_ptr,
   _mem_size, MQX_TICK_STRUCT_PTR);

/* Start CR 871 */
extern boolean _intel_strata_clearlockbits_1byte(IO_FLASHX_STRUCT_PTR, 
   MQX_TICK_STRUCT_PTR);
extern boolean _intel_strata_clearlockbits_2byte(IO_FLASHX_STRUCT_PTR, 
   MQX_TICK_STRUCT_PTR);
extern boolean _intel_strata_clearlockbits_4byte(IO_FLASHX_STRUCT_PTR, 
   MQX_TICK_STRUCT_PTR);
/* End CR 871 */

extern boolean _intel_strata_setlockbits_1byte(IO_FLASHX_STRUCT_PTR, 
   MQX_TICK_STRUCT_PTR);
extern boolean _intel_strata_setlockbits_2byte(IO_FLASHX_STRUCT_PTR, 
   MQX_TICK_STRUCT_PTR);
extern boolean _intel_strata_setlockbits_4byte(IO_FLASHX_STRUCT_PTR, 
   MQX_TICK_STRUCT_PTR);

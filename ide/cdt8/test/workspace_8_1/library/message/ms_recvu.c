...
/*FUNCTION*------------------------------------------------------------
*
* Function Name   : _msgq_receive_until
* Returned Value  : pointer to a message structure, or NULL if kernel 
*                   time execeds specified time
...
pointer _msgq_receive_until
   (
     ...
     _queue_id              queue_id,
      ...
      /* [IN]  the time in ticks before this request expires */

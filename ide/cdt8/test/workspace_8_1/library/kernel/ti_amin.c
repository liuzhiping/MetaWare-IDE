...
***
*** Comments:      
***   This file contains the function for adding minutes to a tick
*** struct
***                                                               
***
**************************************************************************
...
/*FUNCTION*-------------------------------------------------------------------
 * 
 * Function Name    : _time_add_min_to_ticks
 * Returned Value   : MQX_TICK_STRUCT_PTR - first parameter to function
 * Comments         :
 *   This function adds a quantity in minutes to a tick struct
 *
 *END*----------------------------------------------------------------------*/
...
MQX_TICK_STRUCT_PTR _time_add_min_to_ticks
   (
       ...
       /* [IN] The number of minutes to add */
       _mqx_uint           minutes
   )
{ /* Body */
   MQX_TICK_STRUCT tmp;

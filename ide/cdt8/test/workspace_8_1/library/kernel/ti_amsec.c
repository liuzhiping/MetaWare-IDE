...
***
*** Comments:      
***   This file contains the function for adding milliseconds to a tick
*** struct
***                                                               
***
**************************************************************************
...
/*FUNCTION*-------------------------------------------------------------------
 * 
 * Function Name    : _time_add_msec_to_ticks
 * Returned Value   : MQX_TICK_STRUCT_PTR - first parameter to function
 * Comments         :
 *   This function adds a quantity in milliseconds to a tick struct
 *
 *END*----------------------------------------------------------------------*/
...
MQX_TICK_STRUCT_PTR _time_add_msec_to_ticks
   (
       ...
       /* [IN] The number of milliseconds to add */
       _mqx_uint           msecs
   )
{ /* Body */
   MQX_TICK_STRUCT tmp;

...
*** Comments: 
*** 
***    This file contains the type definitions for the ARC A6 core.
***
*** $Header:arca6.h, 5, 9/15/2005 9:13:23 AM, Behdad Besharat$
***
*** $NoKeywords$
***************************************************************************
*END***********************************************************************/
...
#define PSP_MAXIMUM_INTERRUPT_VECTORS (32)
#else
...
/* Start CR 2396 */
/* ARC PMU Aux registers */
#define PSP_AUX_PMU_BUILD_CONFIG           (0x0F7)
#define PSP_AUX_PMU_STATUS                 (0x450)
#define PSP_AUX_PMU_WAKE                   (0x451)
#define PSP_AUX_PMU_DVFS_PERFORMANCE       (0x452)
#define PSP_AUX_PMU_SIMD_PWR_CTRL          (0x453)

/* PMU status register bits */
#define PSP_AUX_PMU_STATUS_RC_RST          (0x0)
#define PSP_AUX_PMU_STATUS_RC_DBUG         (0x4)
#define PSP_AUX_PMU_STATUS_RC_EXT          (0x8)
#define PSP_AUX_PMU_STATUS_RC_WT0          (0x10)
#define PSP_AUX_PMU_STATUS_RC_WT1          (0x20)
/* End CR 2396 */

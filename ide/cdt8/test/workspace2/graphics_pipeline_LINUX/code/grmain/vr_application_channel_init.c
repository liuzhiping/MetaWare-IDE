...
VrCircularBuffer_render_channel0 render_channel0_channel_impl __attribute__ ((section(".render_channel0"), aligned(4)));
int render_channel0_channel_impl_send_count = 0;
int render_channel0_channel_impl_full_count = 0;
int render_channel0_channel_impl_recv_count = 0;
...
vr_channel_setup_global (void)
{
  ...
  do
    {
      __vr_channel_impl_ptr = &vr_get_channel_impl (render_channel0_id);
    }
  while (0);
...
vr_channel_setup_sender_process (void)
{
  ...
  do
    {
      __vr_channel_impl_ptr = &vr_get_channel_impl (render_channel0_id);
      * __vr_channel_impl_ptr = (void *) (&render_channel0_channel_impl);
      VrCircularBufferNoSync_setup ((VrCircularBuffer_render_channel0 *) (((char *) (* __vr_channel_impl_ptr))));
    }
  while (0);
  ...
  do
    {
      ...
      * __vr_channel_impl_ptr = (void *) (&render_channel1_channel_impl);
      VrCircularBufferNoSync_setup ((VrCircularBuffer_render_channel1 *) (((char *) (* __vr_channel_impl_ptr))));
    }
  while (0);
...
vr_channel_setup_sender_thread (uint32_t thread_id)
{
  ...
  switch (thread_id)
    ...
    case swarch_thd_grmain_thread_id:
      ...
      do
        {
          void ** __vr_channel_impl_ptr VR_UNUSED_VARIABLE_ATTRIBUTE = &vr_get_channel_impl (render_channel0_id);
        }
      while (0);

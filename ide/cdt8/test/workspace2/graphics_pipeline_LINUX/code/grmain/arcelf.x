...
/* Generated arc-elf-32 Linker Script for process "grmain" */
...
"elf32-littlearc")
 ...
 SECTIONS
 {
   ...
   PROVIDE (__executable_start = 0x00000100); . = 0x00000100 + SIZEOF_HEADERS;
   .interp         : { *(.interp) }
   .hash           : { *(.hash) }
   .dynsym         : { *(.dynsym) }
   .dynstr         : { *(.dynstr) }
  ...
  /*  physical address: 0x02000000 */
   ...
   .render_channel0 (NOLOAD) : { *(.render_channel0) } 

   /* user section ".render_channel1" */
   .render_channel1 (NOLOAD) : { *(.render_channel1) } 

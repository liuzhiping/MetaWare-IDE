...
/* symbols attached to process grmain in software architecture*/

#define NUMBER_OF_CPU_ISLANDS                                   4
#define OUT_CHANNEL_LIST                                        { render_channel0, render_channel1 }

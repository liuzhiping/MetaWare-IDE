...
#define __vr_channel_impl ((void *) vr_get_channel_impl (__vr_channel_id))
  ...
  switch (__vr_channel_id)
    ...
    case display_channel1_id:
      do 
        {
          VrCircularBuffer_display_channel1* cir_buf = ((VrCircularBuffer_display_channel1 *) __vr_channel_impl);
          ...
          if (__vr_result==__vr_msg_size) {
            display_channel1_channel_impl_send_count++;
          } else {
            display_channel1_channel_impl_full_count++;
          }
        } while(0);
      break;
    }
...
#define __vr_channel_impl ((void *) vr_get_channel_impl (__vr_channel_id))
  ...
  switch (__vr_channel_id)
    ...
    case render_channel1_id:
      do 
        {
          VrCircularBufferNoSync_rp_read (((VrCircularBuffer_render_channel1 *) __vr_channel_impl), 512, __vr_msg, __vr_msg_size, 1, 0, __vr_result, __vr_result);

          if (__vr_result==__vr_msg_size) {
            render_channel1_channel_impl_recv_count++;
          }
        } while(0);
      break;
    }

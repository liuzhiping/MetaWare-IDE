...
/* generated Bare Hardware Linker Script for process "rendermain1" */


MEMORY
{
              vtable:  origin = 0x00000000, length = 0x00000800
  OS_3_imemory_model:  origin = 0x03900000, length = 0x00300000
...
__FREE_MEM_END = ADDR(OS_3_imemory_model) + SIZEOF(OS_3_imemory_model);
/* EOF */

 ...
 */
public class CDILocalVariable extends CDIVariable implements ICDILocalVariable {


    public CDILocalVariable(ISeeCodeVariableDescriptor v, VariableManager vmgr) {
        super(v,vmgr);
    }

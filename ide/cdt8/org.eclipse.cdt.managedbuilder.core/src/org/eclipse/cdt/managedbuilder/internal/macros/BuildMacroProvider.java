...
import org.eclipse.cdt.managedbuilder.core.ManagedBuilderCorePlugin; //CUSTOMIZATION XKORAT
...
import org.eclipse.core.runtime.IStatus; //CUSTOMIZATION XKORAT
import org.eclipse.core.runtime.Status; //CUSTOMIZATION XKORAT
	...
	public String resolveValue(String value, String nonexistentMacrosValue,
		...
		if(info != null){
			try {
			    ...
			    // <CUSTOMIZATION SYNOPSYS>
			    IStatus status = new Status(IStatus.ERROR,ManagedBuilderCorePlugin.PLUGIN_ID,"Can't resolve \"" + value + "\"",e);
			    //</CUSTOMIZATION>
		            throw new BuildMacroException(status);
			}
		}
		return value;
	}

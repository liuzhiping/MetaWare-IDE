...
public interface ITestMetaDataWriter extends ITestMetaData {

    /**
     * Enter the description for a test.
     * @param testName name of test.
     * @param description description of test.
     */
    void enterDescription(String testName, String description);
    
    /**
     * Indicate that the given test must be done manually.
     * @param testName the name of the test.
     */
    void setManualTest(String testName);
}

...
public class T_2_23 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = "Confirm that SeeCode display states are saved between sessions, particularly profiling columns (to be automated).";

    public void testT_2_23() throws Exception {

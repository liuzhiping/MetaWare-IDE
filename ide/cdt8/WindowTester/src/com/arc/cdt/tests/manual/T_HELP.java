...
public class T_HELP extends UIArcTestCaseSWT {
    public static final String CATEGORY = HELP_SYSTEM;
    public static final String DESCRIPTION = "Confirm that online help files have no broken links and compare them to a base line.";
    public void testT_4_5() throws Exception {

...
public class T_4_3 extends UIArcTestCaseSWT {
    public static final String CATEGORY = GENERIC_CDT_TESTS;
    public static final String DESCRIPTION = "Confirm that indexer works for large, multi-compilational-unit C++ application. (Should be automated).";
    public void testT_4_3() throws Exception {

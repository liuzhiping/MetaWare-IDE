...
public class T_1_4 extends UIArcTestCaseSWT {
    public static final String CATEGORY = INSTALLATION;
    public static final String DESCRIPTION = "Confirm that IDE is in C perspective after Welcome screen dismissed";

    public void testT_1_4() throws Exception {

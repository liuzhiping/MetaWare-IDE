...
public class T_MQX_2 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = "Termsim Tests: " + 
       "Run the Demo example and ensure that a) Termsim window appears in debug perspective" +
       " b) \"Hello from Main………..\" appears in termsim window.  The user should not be " +
       "required to open any windows or take any action to view termsim.  It should just " +
       "\"be there\" when they start the debug session. " +
       "Also, terminate and restart execution several times and ensure that output appears " +
       "consistently for each run.";

    public void testT_MQX_2() throws Exception {

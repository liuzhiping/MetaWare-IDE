...
public class T_1_1 extends UIArcTestCaseSWT {
    public static final String CATEGORY = INSTALLATION;
    public static final String DESCRIPTION = "Confirm that appropriate default workspace is prompted during initial startup";

    public void testT_1_1() throws Exception {

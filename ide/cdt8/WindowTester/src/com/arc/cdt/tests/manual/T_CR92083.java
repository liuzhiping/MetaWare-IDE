...
public class T_CR92083 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = 
        "Set a breakpoint and terminate the IDE. Move the workspace to another location. "+
        "Confirm that the breakpoint gets properly activated from the new workspace.";
    public void testT_CR92083() throws Exception {

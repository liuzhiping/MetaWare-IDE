...
public class T_3_5 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = "Confirm Variable view highlights variables as their values change during stepping (should be automated).";
    public void testT_3_5() throws Exception {

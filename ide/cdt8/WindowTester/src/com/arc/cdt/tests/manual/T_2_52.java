...
public class T_2_52 extends UIArcTestCaseSWT {
    public static final String CATEGORY = PROJECT_MANAGEMENT;
    public static final String DESCRIPTION = "Confirm that workspaces from 8.1 convert over and that the small-data model is properly transfered.";
    public void testT_2_52() throws Exception {

...
public class T_2_27 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = "Confirm that SeeCode fonts and colors can be changed from Prefernces (automatable?)";
  
    public void testT_2_27() throws Exception {

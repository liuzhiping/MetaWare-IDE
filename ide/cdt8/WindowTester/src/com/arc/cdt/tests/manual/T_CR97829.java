...
public class T_CR97829 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = 
        "Confirm that copy-to-clipboard works correctly. Include multi-line selection as well as"+
        " multi-column from the TAD displays.";
    public void testT_CR97829() throws Exception {

...
public class T_CR98894 extends UIArcTestCaseSWT {
    public static final String CATEGORY = INSTALLATION;
    public static final String DESCRIPTION = 
        "Confirm that the eclipse.ini file is writable under Linux. The update mechanism requires this.";
    public void testT_CR98894() throws Exception {

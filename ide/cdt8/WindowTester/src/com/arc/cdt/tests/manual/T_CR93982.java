...
public class T_CR93982 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = "Confirm that rapid scrolling of MetaWare displays (e.g. Source) doesn't garble the text.";
    public void testT_CR93982() throws Exception {

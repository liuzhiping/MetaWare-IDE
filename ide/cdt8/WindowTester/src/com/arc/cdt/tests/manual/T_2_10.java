...
public class T_2_10 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = "Confirm that SeeCode command history is preserved between sessions";

   
    public void testT_2_10() throws Exception {

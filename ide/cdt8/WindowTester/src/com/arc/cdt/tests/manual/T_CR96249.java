...
public class T_CR96249 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = 
        "Confirm that when you switch to a new workspace from the Welcome screen that the Welcome screen does *NOT* appear."+
        "The C/C++ perspective should show up.";

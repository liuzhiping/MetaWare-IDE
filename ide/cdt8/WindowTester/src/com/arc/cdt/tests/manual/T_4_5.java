...
public class T_4_5 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = "Confirm that F1 Help works on all our CDT extensions (should be automated).";

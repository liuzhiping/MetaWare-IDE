...
public class T_CR94058 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = "Confirm that when the license server is delayed, a progress bar pops up.";
    public void testT_CR94058() throws Exception {

...
public class T_CR98510 extends UIArcTestCaseSWT {
    public static final String CATEGORY = PROJECT_MANAGEMENT;
    public static final String DESCRIPTION = 
        "Confirm that \"All Configurations\" works in build settings (needs to be automated).";
    public void testT_CR98510() throws Exception {

...
public class T_CR101097 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = 
        "Confirm that prelaunch of SCxISS application works for non-CMPD and CMPD cases.";
    public void testT_CR101097() throws Exception {

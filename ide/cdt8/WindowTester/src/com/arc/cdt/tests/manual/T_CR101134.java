...
public class T_CR101134 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = 
        "Confirm that CMPD configurations can be created without projects being specified.";
    public void testT_CR101134() throws Exception {

...
public class T_CR94187 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = 
        "Confirm that an appropriate error box pops up when a JRE 1.5 is used to invoke the IDE.";
    public void testT_CR94187() throws Exception {

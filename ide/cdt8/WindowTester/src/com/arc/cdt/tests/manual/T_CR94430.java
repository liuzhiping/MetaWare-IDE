...
public class T_CR94430 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = 
        "Confirm that F1 key works on debugger options of Launch Configuration dialog.";
    public void testT_CR94430() throws Exception {

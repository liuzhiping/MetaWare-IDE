...
public class T_2_21 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = "Verify that XCAM model can be launched (to be automated).";
  
    public void testT_2_21() throws Exception {

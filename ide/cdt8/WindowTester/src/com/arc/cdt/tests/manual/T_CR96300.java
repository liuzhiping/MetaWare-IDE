...
public class T_CR96300 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = 
        "Run a CMPD session and set breakpoints from the CDT editor. Confirm that no false yellow markers appear" + 
        " that erroneously show unresolved breakpoints.";
    public void testT_CR96249() throws Exception {

...
public class T_CR96277 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = 
        "Confirm that the debugger can be launched at startup via \"-launch <launchName>\".";
    public void testT_CR96277() throws Exception {

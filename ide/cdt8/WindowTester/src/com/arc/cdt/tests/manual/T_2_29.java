...
public class T_2_29 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = "Confirm that \"Save to file...\" menu item in some SeeCode displays works (WT can't automate)";
    public void testT_2_29() throws Exception {

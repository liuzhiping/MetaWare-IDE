...
public class T_1_2 extends UIArcTestCaseSWT {
    public static final String CATEGORY = INSTALLATION;
    public static final String DESCRIPTION = "Confirm maximized Welcome screen on new workspace";
    
    public void testT_1_2() throws Exception {

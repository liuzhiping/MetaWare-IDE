...
public class T_2_64 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = "Eyeball the About Debugger under the Debugger Menu (should be automated).";
    public void testT_2_64() throws Exception {

...
public class T_2_24 extends UIArcTestCaseSWT {
    public static final String CATEGORY = DEBUGGER_INTEGRATION;
    public static final String DESCRIPTION = "Confirm that F1 help works for Change dialog (not automatable with WT).";

   
    public void testT_2_24() throws Exception {

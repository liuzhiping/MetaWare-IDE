...
public interface ICDTLaunchConfigurationConstants {
	...
	/**
     * Launch configuration attribute key. The value is a boolean specifying
     * whether to resume at start. Only refeferenced if STOP_AT_MAIN is not set.
     * <P>
     * CUSTOMIZATION
     */
    public static final String ATTR_DEBUGGER_RESUME_AT_START = CDT_LAUNCH_ID + ".DEBUGGER_RESUME_AT_START"; //$NON-NLS-1$
    public static final String ATTR_NOPROJECT = CDT_LAUNCH_ID + ".NOPROJECT"; //$NON-NLS-1$
    public static final String ATTR_NOPROJECT_SESSION_DIRECTORY = CDT_LAUNCH_ID + ".NOPROJECT_SESSION_DIRECTORY";
    public static final String ATTR_NOPROJECT_IMPORT_BCF_FILE =  CDT_LAUNCH_ID + ".NOPROJECT_IMPORT_BCF_FILE";
	...
	/**
     * Default value for Resume at startup attribute.
     * <P>
     * CUSTOMIZATION
     */
    public static boolean DEBUGGER_RESUME_AT_STARTUP_DEFAULT = true;
	...
	/**
     * A disassembly view ID if the debugger relies on a disassembler other than the default.
     * <P>
     * CUSTOMIZATION
     */
    public static final String ATTR_DEBUGGER_DISASSEMBLY_VIEW_ID = CDT_LAUNCH_ID + ".disassemblyViewID"; //$NON-NLS-1$

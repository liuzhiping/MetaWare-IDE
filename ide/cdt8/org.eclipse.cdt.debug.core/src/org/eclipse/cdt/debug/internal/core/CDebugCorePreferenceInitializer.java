...
public class CDebugCorePreferenceInitializer extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		...
		//CUSTOMIZATION 
		//CDebugCorePlugin.getDefault().getPluginPreferences().setDefault( ICDebugConstants.PREF_DEFAULT_REGISTER_FORMAT, ICDIFormat.HEXADECIMAL ); //CUSTOMIZATION: HEXADECIMAL 7.0
		defaultPreferences.putInt(ICDebugConstants.PREF_DEFAULT_REGISTER_FORMAT,ICDIFormat.HEXADECIMAL ); //CUSTOMIZATION: HEXADECIMAL 8.1

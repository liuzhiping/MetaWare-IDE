...
public abstract class CVariable extends AbstractCVariable implements ICDIEventListener, ICWatchpointTarget {
	...
	interface IInternalVariable {
		...
		void preserve();
		//CUSTOMIZATION
		//Indicate that a child changed; causes "isChanged()" to be true. CUSTOMIZATION
        void setChildChanged();
	...
	//CUSTOMIZATION to protected
	protected IInternalVariable getOriginal() {
		return fOriginal;
	}

...
//    boolean isProgressDisplayCanceled(int id);
    ...
    /**
     * The debugger needs to shut down. Do whatever is necessary on the IDE side to
     * make this happen.
     * This method is called when the user terminates the debugger session, or if there
     * is a fatal error of some sort.
     * <P>
     * This method was added in version 32 of the ABI interface.
     * @new
     */
    void shutdown();

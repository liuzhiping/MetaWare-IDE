...
public interface ISquareCanvasCallback {
     ...
     * @param canvas the associated {@Link ISquareCanvas} object.
     * @param startLine the line number (0-based, relative to start
     * of model).
     * @param startLineColumn the column number (0-based).
     * @param endLine the line number (0-based, relative to start
     * of model).
     */
    public void setSelectedLine(ISquareCanvas canvas, int startLine, int startLineColumn, int endLine);

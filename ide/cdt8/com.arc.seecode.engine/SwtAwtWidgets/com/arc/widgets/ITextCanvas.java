...
//    void scrollVertically(int amount);
    ...
    interface IObserver {
         ...
         * @param canvas
         * @param startLineNumber the 0-based line number that
         * was clicked.
         * @param endLineNumber the 0-based line number that
         * was clicked.
         * @param startLineColumn the 0-based column that was clicked.
         */
        void onSelected(ITextCanvas canvas, int startLineNumber, int startLineColumn, int endLineNumber);

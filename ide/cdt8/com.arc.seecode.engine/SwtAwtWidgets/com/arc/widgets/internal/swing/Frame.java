...
class Frame extends JFrame implements IWindow, WindowListener {

    private static final long serialVersionUID = 1L;
    private List<IObserver> mObservers = new ArrayList<IObserver>();
    private boolean mDisposed = false;
    
    Frame(IComponentFactory fact) {
        mFactory = fact;
    ...
    public IContainer getContents() {
        return mFactory.wrapContainer(this.getContentPane(),IComponentFactory.GRID_STYLE);
    }

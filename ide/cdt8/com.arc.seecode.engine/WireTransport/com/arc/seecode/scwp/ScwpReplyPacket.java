...
/**
 * A reply packet. This class was adapted from IBM's JdwpReplyPacket.
 * 
 * @author David Pickens
 */
public class ScwpReplyPacket extends ScwpPacket {

    /** Error code constants. */
    public static final short NONE = 0;

    public static final short NOT_YET_IMPLEMENTED = 1;
    ...
    public static void getConstantMaps() {
        if (fErrorMap != null) { return; }

        Field[] fields = ScwpReplyPacket.class.getDeclaredFields();
        fErrorMap = new HashMap<Integer,String>(fields.length);
        for (int i = 0; i < fields.length; i++) {
            Field field = fields[i];
            if ((field.getModifiers() & Modifier.PUBLIC) == 0
                    || (field.getModifiers() & Modifier.STATIC) == 0
                    || (field.getModifiers() & Modifier.FINAL) == 0) continue;

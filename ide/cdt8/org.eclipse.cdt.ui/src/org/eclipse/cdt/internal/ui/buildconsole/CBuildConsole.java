...
public class CBuildConsole implements ICConsole {
	...
	public ConsoleOutputStream getOutputStream() throws CoreException {
		...
		//CUSTOMIZATION
		//Global Console is BuildConsolePartitioner. It will create each outputstream for each call
		return GlobalBuildConsoleManager.getGlobalConsole().getOutputStream();
	...
	public ConsoleOutputStream getInfoStream() throws CoreException {
		...
		//CUSTOMIZATION
		return GlobalBuildConsoleManager.getGlobalConsole().getInfoStream();
	}
	...
	public ConsoleOutputStream getErrorStream() throws CoreException {
		...
		//CUSTOMIZATION
		return GlobalBuildConsoleManager.getGlobalConsole().getErrorStream();
	}
}

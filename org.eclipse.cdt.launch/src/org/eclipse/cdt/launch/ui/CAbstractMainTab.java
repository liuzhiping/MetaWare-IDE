 ...
 *     IBM Corporation
 *      Synopsys Incorporated -- integration of MetaWare debugger
 *******************************************************************************/
...
public abstract class CAbstractMainTab extends CLaunchConfigurationTab {
	...
	private String fCachedSelectionConfigID = null;  // CUSTOMIZATION
	/**
	 * @since 6.0
	 */
	protected void updateBuildConfigCombo(String selectedConfigID) {
		if (fBuildConfigCombo != null && !selectedConfigID.equals(fCachedSelectionConfigID))
		{
		    fCachedSelectionConfigID = selectedConfigID;
	...
	protected void updateProgramFromConfig(ILaunchConfiguration config) {
		if (fProgText != null)
		{
			...
			//CUSTOMIZATION: Text::setText fires change event even if it didn't change. This wreaks havoc with performance
			if (!programName.equals(fProgText.getText()))

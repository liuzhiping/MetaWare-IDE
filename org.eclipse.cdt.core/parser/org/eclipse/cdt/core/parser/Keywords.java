...
public class Keywords {
	...
	private static void addCpp(CharArrayIntMap cppkeywords) {
        ...
        cppkeywords.put("_Override".toCharArray(), IToken.t_virtual); // CUSTOMIZATION //$NON-NLS-1$
	...
	public static void addKeywordsPreprocessor(CharArrayIntMap ppKeywords) {
        ...
        ppKeywords.put("c_include".toCharArray(), IPreprocessorDirective.ppInclude); //CUSTOMIZATION //$NON-NLS-1$

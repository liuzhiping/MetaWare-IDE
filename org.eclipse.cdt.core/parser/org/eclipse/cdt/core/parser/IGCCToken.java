...
public interface IGCCToken extends IToken {
	...
	public static final int t_mw_typeof = FIRST_RESERVED_IGCCToken + 6; // _Typeof<id> from MetaWare C //CUSTOMIZATION
	public static final int t_PRAGMA = FIRST_RESERVED_IGCCToken + 7; // _Pragma from MetaWare //Customization

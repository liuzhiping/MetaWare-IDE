 ...
 *     David Pickens -- Synopsys Incorporated
 *******************************************************************************/
...
public class CContainer extends Openable implements ICContainer {
	...
	private boolean fHasCSourceComputed = false; //CUSTOMIZATION
	private boolean fHasCSource = false;		//CUSTOMIZATION
    ...
    /**
     * @return whether or not there are C/C++ source files in this container.
     * <P>
     * CUSTOMIZATION
     */
    public boolean hasCSource () {
        if (fHasCSourceComputed) {
            return fHasCSource;
        }
        fHasCSourceComputed = true; 
	 ...
	 // CUSTOMIZATION
    private void setHasCSource(boolean c){
        fHasCSourceComputed = true;
        fHasCSource = c;
        ICElement parent = this.getParent();
        if (c && parent instanceof CContainer){
            ((CContainer)parent).setHasCSource(true);
        }
    }
}

...
public class Elf {
	...
	public class ELFhdr {
		...
		public final static int EM_ARC = 45;      /*CUSTOMIZATION ARC*/
		...
		public final static int EM_ARC_A5 = 93;       /*CUSTOMIZATION ARC*/     
		public final static int EM_XTENSA = 94;
		public final static int EM_VIDEOCORE = 95;    /*CUSTOMIZATION ARC*/        
		...
		public final static int EM_VIDEOCORE3 = 137;    /*CUSTOMIZATION ARC*/
		public final static int EM_MMDSP = 160;
		public final static int EM_ARC_COMPACT2 = 195; /*CUSTOMIZATION ARC*/
		...
		private final short makeShort(byte[] val, int offset, boolean isle) throws IOException {
			...
			//CUSTOMIZATION: and with 0xFF
			if (isle) {
				return (short) ( (val[offset + 1] << 8) + (val[offset + 0]&0xFF));
			}
			return (short) ( (val[offset + 0] << 8) + (val[offset + 1]&0xFF));
		}
	...
	public Attribute getAttributes() throws IOException {
		...
		switch (ehdr.e_machine & 0xFFFF) {
			...
			case Elf.ELFhdr.EM_ARM :
				...
				break;
			case Elf.ELFhdr.EM_ARC :   // CUSTOMIZATION ARC
				attrib.cpu = "arc"; //$NON-NLS-1$
				break;
			case Elf.ELFhdr.EM_ARC_COMPACT2 : // CUSTOMIZATION ARC
				attrib.cpu = "ac2"; //$NON-NLS-1$
				break;
			case Elf.ELFhdr.EM_ARC_A5 :   // CUSTOMIZATION ARC
				attrib.cpu = "ac"; //$NON-NLS-1$
				break;
			case Elf.ELFhdr.EM_VIDEOCORE :   // CUSTOMIZATION ARC
				attrib.cpu = "vc"; //$NON-NLS-1$
				break;
            case Elf.ELFhdr.EM_VIDEOCORE3 :   // CUSTOMIZATION ARC
                attrib.cpu = "vc3"; //$NON-NLS-1$
                break;

 ...
 */
class ByteArraySerializer implements ISerializer {

    private ByteArraySerializer(){}
    private static ISerializer sInstance = new ByteArraySerializer();
    public static ISerializer getInstance() {
        return sInstance;
    }
    
    private static final int MAGIC = 0x11223344; // arbitrary magic number
    /* (non-Javadoc)

 ...
 *     Synopsys -- customization for MetaWare toolset
 *******************************************************************************/
...
public interface IConfiguration extends IBuildObject, IBuildObjectPropertiesContainer {
    ...
    public static final String EXTRA_DEPENDENT = "extraDependent"; //CUSTOMIZATION //$NON-NLS-1$
	...
	/**
     * Set extra dependents that the main artifact depends on, say, from the pre or post steps.
     * <P>
     * CUSTOMIZATION
     * @param v array of dependents
     */
    public void setExtraDependents(String v[]);
    
    /**
     * Return extra dependents that the main artifact depends on, say, from the pre or post steps.
     * <P>
     * CUSTOMIZATION
     * @return return the extra dependents, or zero length array if there are none.
     */

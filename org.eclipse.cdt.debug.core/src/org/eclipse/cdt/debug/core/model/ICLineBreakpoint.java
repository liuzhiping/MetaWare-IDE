...
public interface ICLineBreakpoint extends ICBreakpoint, ILineBreakpoint {
     ...
     * CUSTOMIZATION
     * <P>
     * Breakpoint attribute storing the number of bytes offset from a source
     * line. This attribute is an <code>int</code>.
     */
    public static final String OFFSET_FROM_LINE = "org.eclipse.cdt.debug.core.byteOffsetFromLine"; //$NON-NLS-1$ 
    /**
     * CUSTOMIZATION
     * <P>
     * Breakpoint attribute storing the number of bytes offset from a function
     * entry point. This attribute is an <code>int</code>.
     */
    public static final String OFFSET_FROM_FUNCTION = "org.eclipse.cdt.debug.core.byteOffsetFromFunction"; //$NON-NLS-1$ 
     ...
     * CUSTOMIZATION
     * <P>
     * Return the number of bytes from the source line.
     * @return the number of bytes from the source line.
     ...
     * CUSTOMIZATION
     * <P>
     * Return the number of bytes from the function entry point.
     * @return the number of bytes from the source line.
     * @throws CoreException
     */

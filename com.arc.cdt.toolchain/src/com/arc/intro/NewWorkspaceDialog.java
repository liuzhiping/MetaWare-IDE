...
public class NewWorkspaceDialog extends TitleAreaDialog {
    ...
    /**
     * Create a modal dialog on the argument shell, using and updating the argument data object.
    ...
    private void createExtraTextInfoMsgPanel (Composite parent) {
        ...
        Label label = new Label(panel, SWT.NONE);
        label
                .setText(ToolchainPlugin.getTheProductName()
                        + " will automatically restart to complete this operation.");
    }

...
/*
 * HighCDependencyGenerator
 * $Revision$
 * $Date$
 *
 * CONFIDENTIAL AND PROPRIETARY INFORMATION.
 * Copyright 2004 ARC International (Unpublished).
 * All Rights Reserved.
 ...
 */
public class HighCDependencyGenerator implements IManagedDependencyGenerator2 {

    /**
     * {@inheritDoc} Implementation of overridden (or abstract) method.
     * @return type indicating how dependencies are generated
     */
    ...
    public IManagedDependencyInfo getDependencySourceInfo (IPath source, IBuildObject buildContext, ITool tool, IPath topBuildDirectory) {
        return new HighCDependencyCommands(source,buildContext,tool,topBuildDirectory);
    }

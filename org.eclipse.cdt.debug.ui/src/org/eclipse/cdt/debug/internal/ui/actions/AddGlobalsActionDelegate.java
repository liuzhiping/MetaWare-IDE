	...
	protected void doAction( Object element ) throws DebugException {
		...
		if ( element != null && element instanceof IDebugElement ) {
			...
			if ( info != null && gvm != null ) {
				...
				IGlobalVariableDescriptor[] descriptors = gvm.getDescriptors();
				...
				if ( dlg.open() == Window.OK ) {
                    ...
                    if (toBeRemoved.size() > 0) {
                        gvm.removeGlobals((IGlobalVariableDescriptor[])toBeRemoved.toArray( new IGlobalVariableDescriptor[toBeRemoved.size()]));
                    }
                    //</CUSTOMIZATION>

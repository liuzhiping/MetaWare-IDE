...
public class Arc4ApplicabilityCalculator implements IOptionApplicability {

    // There is one instance of this class per option. But we want
    // to share the same enablement manager. So make it static.
    private static final Arc4OptionEnablementManager EMGR = new Arc4OptionEnablementManager();

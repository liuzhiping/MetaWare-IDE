...
public class BuildOptionComboFieldEditor extends FieldEditor {
	...
	public BuildOptionComboFieldEditor (String name, String label, String [] opts, String sel, Composite parent) {
		init(name, label);
		setOptions(opts);
		selected = TextProcessor.process(sel);  //SYNOPSYS
		//selected = sel;
	...
	protected void doLoad() {
		...
		selected = TextProcessor.process(selected); // SYNOPSYS
	...
	protected void doStore() {
		...
		getPreferenceStore().setValue(getPreferenceName(), TextProcessor.deprocess(selected)); // SYNOPSYS
	}
